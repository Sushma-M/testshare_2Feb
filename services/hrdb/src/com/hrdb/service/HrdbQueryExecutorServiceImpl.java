...
public class HrdbQueryExecutorServiceImpl implements HrdbQueryExecutorService {
    ...
    public Page<UserDetailsResponse> executeUserDetails(Pageable pageable) {
        ...
        return queryExecutor.executeNamedQuery("userDetails", params, UserDetailsResponse.class, pageable);
    }

    @Transactional(readOnly = true, value = "hrdbTransactionManager")
    @Override
    public Downloadable exportUserDetails(ExportType exportType, Pageable pageable) {
        Map params = new HashMap(0);


        return queryExecutor.exportNamedQueryData("userDetails", params, exportType, UserDetailsResponse.class, pageable);
    }
